...
class SPGG_Qlearning(nn.Module):
    ...
    def shot_save_data(self, type_t_matrix: tensor,profit_matrix, i, r,generated="generated1"):
        self.mkdir('data/Qlearning/shot_pic/r={}/two_type/{}/type_t_matrix'.format(r,str(generated)))
        np.savetxt('data/Qlearning/shot_pic/r={}/two_type/{}/type_t_matrix/{}_r={}_epoches={}_L={}_T={}_{}times.txt'.format(str(r),str(generated), "type_t_matrix", str(r), str(self.epoches), str(self.L_num),str(i),str(self.count)),type_t_matrix.cpu().numpy())
        self.mkdir('data/Qlearning/shot_pic/r={}/two_type/{}/profit_matrix'.format(r,str(generated)))
        np.savetxt('data/Qlearning/shot_pic/r={}/two_type/{}/profit_matrix/{}_r={}_epoches={}_L={}_T={}_{}次times.txt'.format(str(r),str(generated),"profit_matrix", str(r), str(self.epoches), str(self.L_num), str(i), str(self.count)),profit_matrix.cpu().numpy())
    ...
    def save_data(self,type,name,r,count,data):
        self.mkdir('data/Qlearning/'+str(type))
        try:
            np.savetxt('data/Qlearning/{}/{}_r={}_epoches={}_L={}_{}times.txt'.format(str(type), name, str(r),str(self.epoches),str(self.L_num), str(count)),data)
        except:
            print("Save failed")
